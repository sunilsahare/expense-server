...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<HttpApiResponse> expenseMisMatchException(ExpenseIdMissMatchException ex){
        return new ResponseEntity<>(buildApiResponse(ex.getMessage()), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(UserNotFoundException.class)
    public ResponseEntity<HttpApiResponse> userNotFoundException(UserNotFoundException ex){
        return new ResponseEntity<>(buildApiResponse(ex.getMessage()), HttpStatus.NOT_FOUND);
    }
    ...
    public ResponseEntity<HttpApiResponse<Object>> badCredentialException(BadCredentialsException ex){
        return new ResponseEntity<>(buildApiResponse(ex.getMessage()+ " - Enter valid username/password"), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<HttpApiResponse> handleValidationError(MethodArgumentNotValidException ex) {
        ...
        HttpApiResponse httpApiResponse = buildApiResponse("Validation Error occurred for following fields");
    ...
    public ResponseEntity<HttpApiResponse> exception(Exception ex){
        ex.printStackTrace();
        return new ResponseEntity<>(buildApiResponse("An Server Exception occurred!"), HttpStatus.INTERNAL_SERVER_ERROR);
    }
